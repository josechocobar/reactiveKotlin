...
import com.chocobar.reactiveKotlin.di.QuestRepository
...
class QuestController {
    ...
    suspend fun createQuest(
        ...
        return QuestRequestResponse(
            id = id,
            text = createdQuest.text,
            answer1 = createdQuest.answer1,
            answer2 = createdQuest.answer2,
            answer3 = createdQuest.answer3,
            answer4 = createdQuest.answer4
        )
    }
    ...
    suspend fun getQuest(
        ...
        if (quest!=null){
            val questRequestResponse = QuestRequestResponse(
                id = questId,
                text = quest.text,
